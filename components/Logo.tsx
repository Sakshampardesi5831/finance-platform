 ...
 * Logo component
 * @param {object} props
 * @param {number|string} [props.width=56]
 * @param {number|string} [props.height=40]
 * @param {string} [props.color="#fff"] - SVG fill color
 * @param {string} [props.className]
 * @param {string} [props.title] - accessible title
 */
export default function Logo({ width = 56, height = 40, color = '#fff', className = '', title = 'Logo', ...props }) {
  return (
    <svg
      width={width}
      height={height}
